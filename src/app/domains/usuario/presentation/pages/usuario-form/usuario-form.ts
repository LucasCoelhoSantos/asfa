...
import { AtualizarUsuarioProps, AtualizarPerfilProps, CriarUsuarioProps } from '../../../domain/entities/usuario.entity';
...
export class UsuarioFormComponent implements OnInit {
  ...
  private async criarUsuario(): Promise<void> {
    const props: CriarUsuarioProps = {
      ...
      cargo: this.form.value.cargo as CargoUsuario,
  ...
  private async atualizarUsuario(id: string): Promise<void> {
    if (this.eModoPerfil) {
      ...
      const props: AtualizarUsuarioProps = {
        nome: this.form.value.nome,
        email: this.form.value.email,
        cargo: this.form.value.cargo as CargoUsuario
      };
